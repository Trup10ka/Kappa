...
ALTER TABLE product
DROP CONSTRAINT product_product_category_FK;
...
DROP CONSTRAINT product_to_order_order_FK;
...
ALTER TABLE product_to_order
DROP CONSTRAINT product_to_order_product_FK;
...
CREATE OR REPLACE VIEW most_ordered_products AS
...
CREATE OR REPLACE VIEW customer_products_in_order AS
